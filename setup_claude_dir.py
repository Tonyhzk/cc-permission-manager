...
DEFAULT_EXTERNAL_DIR_WIN = r"Y:\Documents\GitHub\HZK-Daily\.claude"
...
用法:
    python run_claude.py           交互式菜单
    python run_claude.py link      创建符号链接（使用默认路径）
    python run_claude.py unlink    移除符号链接并恢复
    python run_claude.py status    显示当前状态
"""
